System.register(['angular2/src/facade/collection', 'angular2/src/facade/lang', 'angular2/core', 'angular2/src/facade/exceptions', './expression_parser/ast', './expression_parser/parser', './html_parser', './html_tags', './parse_util', 'angular2/src/core/linker/view_utils', './template_ast', 'angular2/src/compiler/selector', 'angular2/src/compiler/schema/element_schema_registry', './template_preparser', './style_url_resolver', './html_ast', './util', './provider_parser'], function(exports_1, context_1) {
    "use strict";
    ...
    var collection_1, lang_1, core_1, lang_2, exceptions_1, ast_1, parser_1, html_parser_1, html_tags_1, parse_util_1, view_utils_1, template_ast_1, selector_1, element_schema_registry_1, template_preparser_1, style_url_resolver_1, html_ast_1, util_1, provider_parser_1;
    var BIND_NAME_REGEXP, TEMPLATE_ELEMENT, TEMPLATE_ATTR, TEMPLATE_ATTR_PREFIX, CLASS_ATTR, PROPERTY_PARTS_SEPARATOR, ATTRIBUTE_PREFIX, CLASS_PREFIX, STYLE_PREFIX, TEXT_CSS_SELECTOR, TEMPLATE_TRANSFORMS, TemplateParseError, TemplateParseResult, TemplateParser, TemplateParseVisitor, NonBindableVisitor, BoundElementOrDirectiveProperty, ElementContext, EMPTY_ELEMENT_CONTEXT, NON_BINDABLE_VISITOR, PipeCollector;
